"""
Django settings for casaroja project.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-casaroja-development-key-12345')
...
WSGI_APPLICATION = 'casaroja.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Casaroja API',
    'DESCRIPTION': 'API para la plataforma cultural Casaroja',
    'VERSION': '1.0.0',
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'casaroja.log',
        },
        'console': {
            'level': 'INFO',
